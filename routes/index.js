...
const uploadFolder = path.join(process.cwd(),'my_uploads');
//  Date.now() + '_' + file.originalname
// var multerStorage = multer({ dest: uploadFolder })
...
upload.single('singleImage'), // middleware multer, nhận đầu vào là tên trường chứa ảnh 'singleImage' (xem trong form input[type=file])
  (req, res) => {
